...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'secondary' | 'ghost' | 'sales' | 'finance' | 'danger';
  fullWidth?: boolean;
...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = "inline-flex items-center justify-center gap-2 min-h-[44px] px-5 py-3 text-[11px] font-black uppercase tracking-[0.2em] transition-all duration-150 ease-in-out active:scale-95 disabled:opacity-40 rounded-xl border-2 shadow-sm whitespace-nowrap overflow-hidden select-none";
  ...
  const variants = {
    ...
    danger: "bg-red-500 text-white border-red-500 hover:bg-red-600 shadow-red-500/20",
  };
