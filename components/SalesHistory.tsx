  ...
  const handleShare = async () => {
    ...
    if (navigator.share) {
      try {
        ...
        // Solo incluimos la URL si es válida y usa protocolos estándar para evitar el error 'Invalid URL'
        ...
        // Si falla por URL inválida o cancelación del usuario, intentamos copiar al portapapeles como fallback
